...
function AlterPasswordDialogProvider({children}: AlterPasswordDialogProviderProps){
...
function useAlterPasswordDialogContext(){
  ...
  if (!context) {
    throw new Error("useAlterPasswordDialogContext must be used within a AlterPasswordDialogProfile");
  }
